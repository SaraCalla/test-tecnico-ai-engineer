...
The structured pipeline parses each question into a structured filter (ingredients, techniques, planet, restaurant, license, distance constraints, technique categories) and applies it programmatically on an in-memory DataFrame of all 300 dishes. This is both faster and more accurate than vector search for this type of query.

I evaluated four alternatives before choosing this approach:
